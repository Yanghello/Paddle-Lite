...
inline ActivationType GetActivationType(const lite_api::ActivationType&type) {
  if (type == lite_api::ActivationType::kSigmoid) {
    return ActivationType::kSigmoid;
  } else if (type == lite_api::ActivationType::kRelu) {
    return ActivationType::kReLU;
  } else if (type == lite_api::ActivationType::kTanh) {
    return ActivationType::kTanh;
  } else if (type == lite_api::ActivationType::kIndentity) {
    return ActivationType::kIdentity;
  }
  LOG(ERROR) << "Not support Activation type.";
  return ActivationType();
}
